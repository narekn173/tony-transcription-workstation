...
ExternalProcessRunner::run(const ExternalProcessRequest &) const
{
    ExternalProcessResult result;
    result.state = AnalysisRunState::NotImplemented;
    result.error = {
        BackendErrorCode::NotImplemented,
        "External process execution is intentionally disabled in the skeleton.",
        true
    };
    return result;
}
